...
fileprivate struct cxxboost_accumulators {
	...
	static let dependencies: Array<Target.Dependency> = [
		...
		"cxxboost_numeric__conversion",
		"cxxboost_typeof",
		"cxxboost_assert",
		"cxxboost_core",
		"cxxboost_config",
		"cxxboost_throw_exception",
		"cxxboost_numeric__ublas",
...
fileprivate struct cxxboost_iostreams {
	static let name: String = "cxxboost_iostreams"
	static let dependencies: Array<Target.Dependency> = [
		"cxxboost_type_traits",
		"cxxboost_static_assert",
		"cxxboost_core",
	...
	static let path: String = "./Modules/cxxboost_iostreams/"
	static let exclude: Array<String> = [".cant-see-me"]
	static let sources: Array<String> = ["src"]
	static let publicHeadersPath: String = "include"
	static let packageAccess: Bool = false
...
fileprivate struct cxxboost_numeric__conversion {
	static let name: String = "cxxboost_numeric__conversion"
	static let dependencies: Array<Target.Dependency> = [
		"cxxboost_preprocessor",
		"cxxboost_config",
		"cxxboost_mpl",
	...
	static let path: String = "./Modules/cxxboost_numeric__conversion/"
	static let exclude: Array<String> = [".cant-see-me"]
	static let sources: Array<String> = []
	static let publicHeadersPath: String = "include"
	static let packageAccess: Bool = false
}
fileprivate struct cxxboost_numeric__interval {
	static let name: String = "cxxboost_numeric__interval"
	static let dependencies: Array<Target.Dependency> = [
		"cxxboost_detail",
		"cxxboost_config",
		"cxxboost_logic"
	]
	static let path: String = "./Modules/cxxboost_numeric__interval/"
	static let exclude: Array<String> = [".cant-see-me"]
	static let sources: Array<String> = []
	static let publicHeadersPath: String = "include"
	static let packageAccess: Bool = false
}
fileprivate struct cxxboost_numeric__odeint {
	static let name: String = "cxxboost_numeric__odeint"
	static let dependencies: Array<Target.Dependency> = [
	...
	static let path: String = "./Modules/cxxboost_numeric__odeint/"
	static let exclude: Array<String> = [".cant-see-me"]
	static let sources: Array<String> = []
	static let publicHeadersPath: String = "include"
	static let packageAccess: Bool = false
}
fileprivate struct cxxboost_numeric__ublas {
	static let name: String = "cxxboost_numeric__ublas"
	static let dependencies: Array<Target.Dependency> = [
		"cxxboost_core",
		"cxxboost_mpl",
		"cxxboost_smart_ptr",
		"cxxboost_numeric__interval",
		"cxxboost_serialization",
		"cxxboost_typeof",
		"cxxboost_concept_check",
		"cxxboost_type_traits",
	...
	static let path: String = "./Modules/cxxboost_numeric__ublas/"
	static let exclude: Array<String> = [".cant-see-me"]
	static let sources: Array<String> = []
	static let publicHeadersPath: String = "include"
	static let packageAccess: Bool = false
...
fileprivate struct cxxboost_thread {
	...
	static let exclude: Array<String> = [".cant-see-me"]
	#else
	static let exclude: Array<String> = [".cant-see-me", "src/win32"]
	#endif
	static let sources: Array<String> = ["src"]
	static let publicHeadersPath: String = "include"
	static let packageAccess: Bool = false
...
fileprivate struct cxxboost_throw_exception {
	...
	static let dependencies: Array<Target.Dependency> = ["cxxboost_assert", "cxxboost_config"]
...
fileprivate struct cxxboost_type_traits {
	...
	static let dependencies: Array<Target.Dependency> = ["cxxboost_config", "cxxboost_static_assert"]
...
fileprivate struct cxxboost_winapi {
	...
	static let dependencies: Array<Target.Dependency> = ["cxxboost_config", "cxxboost_predef"]
...
let package = Package(
	...
	platforms: [.macOS(.v13)],
	products: [
		.library(name:"cxxboost_portable_binary_archives", targets: ["cxxboost_portable_binary_archives"]),
		...
		.library(name: cxxboost_numeric__ublas.name, targets: [cxxboost_numeric__ublas.name]),
		.library(name: cxxboost_numeric__odeint.name, targets: [cxxboost_numeric__odeint.name]),
		.library(name: cxxboost_numeric__interval.name, targets: [cxxboost_numeric__interval.name]),
		.library(name: cxxboost_numeric__conversion.name, targets: [cxxboost_numeric__conversion.name]),
