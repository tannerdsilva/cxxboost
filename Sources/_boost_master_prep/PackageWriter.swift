...
// 		let packageNameLabel = LabeledExprSyntax(label:TokenSyntax.identifier("name"), colon:TokenSyntax.colonToken(), expression:StringLiteralExprSyntax(content:self.source.name.packageTargetName), trailingComma:TokenSyntax.commaToken())
...
// 				LabeledExprSyntax(label:TokenSyntax.identifier("name"), colon:.colonToken(), expression:StringLiteralExprSyntax(content:self.source.name.packageTargetName), trailingComma:.commaToken()),
...
// 					ArrayElementSyntax(expression:StringLiteralExprSyntax(content:self.source.name.packageTargetName))
// 				}))
// 			], rightParen:TokenSyntax.rightParenToken()))
// 		}))
...
// 					LabeledExprSyntax(label:TokenSyntax.identifier("name"), colon:.colonToken(), expression:StringLiteralExprSyntax(content:dependency.name.packageTargetName), trailingComma:.commaToken()),
// 					LabeledExprSyntax(label:TokenSyntax.identifier("path"), colon:.colonToken(), expression:StringLiteralExprSyntax(content:"../" + dependency.name.packageTargetName))
